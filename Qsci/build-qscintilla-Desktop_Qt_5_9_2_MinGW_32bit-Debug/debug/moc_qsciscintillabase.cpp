...
void QsciScintillaBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QsciScintillaBase::*_t)(const char * , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QsciScintillaBase::SCN_AUTOCCOMPLETED)) {
                *result = 3;
                return;
            }
        }
        ...
        {
            typedef void (QsciScintillaBase::*_t)(const char * , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QsciScintillaBase::SCN_AUTOCSELECTIONCHANGE)) {
                *result = 6;
                return;
            }
        }
        ...
        {
            typedef void (QsciScintillaBase::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QsciScintillaBase::SCN_MARGINRIGHTCLICK)) {
                *result = 22;
                return;
            }
        }
        ...
        {
            typedef void (QsciScintillaBase::*_t)(const QUrl & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QsciScintillaBase::SCN_URIDROPPED)) {
                *result = 30;
                return;
            }
        }
        ...
        {
            typedef void (QsciScintillaBase::*_t)(const char * , int , int , int , int );
...
const QMetaObject QsciScintillaBase::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_QsciScintillaBase.data,
      qt_meta_data_QsciScintillaBase,  qt_static_metacall, nullptr, nullptr}
};
