...
void QUIWidget::initControl(){
    ...
    lab_Title->setAlignment(/*Qt::AlignLeading | */Qt::AlignVCenter/* | Qt::AlignVCenter*/);
...
*/
    ...
    btnMenu_Min->setMinimumSize(QSize(/*30*/80, /*0*/50));
    btnMenu_Min->setMaximumSize(QSize(/*30*/80, 16777215));
    ...
    btnMenu_Max->setMinimumSize(QSize(/*30*/80, /*0*/50));
    btnMenu_Max->setMaximumSize(QSize(/*30*/80, 16777215));
    ...
    btnMenu_Close->setMinimumSize(QSize(/*30*/80, /*0*/50));
    btnMenu_Close->setMaximumSize(QSize(/*30*/80, 16777215));
...
void QUIWidget::initForm(){
    //设置图形字体
    //setIcon(QUIWidget::Lab_Ico, 0xf15b/*, 11*/);
    //setIcon(QUIWidget::BtnMenu, 0xf0d7);

    setPixmap(QUIWidget::Lab_Ico, ":/image/logo.png");
...
void QUIWidget::setPixmap(QUIWidget::Widget widget, const QString &pix){
    if (widget == QUIWidget::Lab_Ico) {
        this->lab_Ico->setPixmap(QPixmap(pix));
    } /*else if (widget == QUIWidget::BtnMenu) {
        this->btnMenu->setIcon(QIcon(pix));
    } */else if (widget == QUIWidget::BtnMenu_Min) {
        this->btnMenu_Min->setIcon(QIcon(pix));
    } else if (widget == QUIWidget::BtnMenu_Max) {
        this->btnMenu_Max->setIcon(QIcon(pix));
    } else if (widget == QUIWidget::BtnMenu_Close) {
        this->btnMenu_Close->setIcon(QIcon(pix));
    }
}
...
void QUIInputBox::initForm(){
    //设置图形字体作为图标
    IconHelper::Instance()->setIcon(this->lab_Ico, QChar(0xf072)/*, 11*/);
    IconHelper::Instance()->setIcon(this->lab_Ico, QChar(0xf00d)/*, 9*/);
